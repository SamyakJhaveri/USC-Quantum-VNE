...
def create_dqm_helper_function(G1, G2):
    ...
    """ Code for H_A part 1 as per sub-graph isomorphism's Injectivity rule """
    ...
    """ Code for H_A part 2 the SGI problem. """
    ...
    """ Code for H_B, with 'list index out of range' issue handled for SGI """
    print("\n\n")
    print("For Mapping from G2 to G1")
    # Commented out the old versoin of the sgi code as it did not work well, kept here for 
    # keepsakes and comparison with new one
    """
