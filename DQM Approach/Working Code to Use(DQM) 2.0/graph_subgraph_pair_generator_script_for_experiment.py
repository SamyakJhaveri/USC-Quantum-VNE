...
- turning network graph into adjacency matrix: https://stackoverflow.com/questions/62241880/adjacency-matrix-for-graph-in-python-nympy
...
def generate_child_subgraph(G1, n):
        ...
        # G2 = G1.subgraph(random.sample(list(G1.nodes), n)) # option 2
